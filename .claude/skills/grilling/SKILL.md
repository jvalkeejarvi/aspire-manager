...
Once that's confirmed, suggest what to do next: implement directly for a small, well-understood
change, or write the design down first if it spans more than a session.
